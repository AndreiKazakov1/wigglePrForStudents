...
public class LoginPage extends FactoryPage {
    ...
    public void inputEmailAddress() {
        emailAddressField.sendKeys(VALID_EMAIL);
    }

    public void inputEmailPassword() {
        emailPasswordField.sendKeys(VALID_PASSWORD);
    }
    ...
    public void inputEmailAddressRegistration() {
        emailAddressFieldRegistration.sendKeys(NEW_INVALID_EMAIL);
    }
    ...
    public boolean isErrorMassageDisplayed() {
        return emailErrorMassage.isDisplayed();
    }

    public void inputEmailAddressCuc(String adr) {
        emailAddressField.sendKeys(adr);
    }

    public void inputEmailPasswordCuc(String pass) {
        emailPasswordField.sendKeys(pass);
    }

    public void inputInvalidEmailRegAddressCuc(String adds) {
        emailAddressFieldRegistration.sendKeys(adds);
    }

    public void inputValidEmailRegAddressCuc(String adds) {
        emailAddressFieldRegistration.sendKeys(adds);
    }
